...
public class StateMachine extends SubsystemBase {
    ...
    public void enableStateSetup() {
        ...
        stateTriggers
                ...
                .onTrue(outtake.ejectCorral().andThen(forceState(RobotState.Idle)));
        ...
        stateTriggers
                ...
                .onTrue(
                        Commands.sequence(
                                outtake.shoot(), Commands.sequence(elevator.setTarget(ElevatorSetpoints.INTAKE))));
        ...
        stateTriggers
                ...
                .and(driver.y())
                .onTrue(Commands.sequence(elevator.setTarget(ElevatorSetpoints.L4)));
        stateTriggers
                .get(RobotState.Manual_Score)
                .and(driver.x())
                .onTrue(Commands.sequence(elevator.setTarget(ElevatorSetpoints.L3)));
        stateTriggers
                .get(RobotState.Manual_Score)
                .and(driver.b())
                .onTrue(Commands.sequence(elevator.setTarget(ElevatorSetpoints.L2)));
        stateTriggers
                .get(RobotState.Manual_Score)
                .and(driver.a())
                .onTrue(Commands.sequence(elevator.setTarget(ElevatorSetpoints.L1)));
        ...
        stateTriggers.get(RobotState.Climb_Pull).onTrue(climb.setPosition(ClimbConstants.climbed));
        stateTriggers.get(RobotState.Climb_Ready).onTrue(climb.setPosition(ClimbConstants.ready));
        stateTriggers.get(RobotState.Climb_Stow)
                .onTrue(Commands.parallel(climb.setPosition(ClimbConstants.stow), forceState(RobotState.Idle)));
    }
