...
public class LEDConstants {
    ...
    private static final Alliance kAlliance = DriverStation.getAlliance().isPresent()
            ? DriverStation.getAlliance().get()
            : Alliance.Red;
    public static final double brightness = 0.5;
    public static final int length = 308;

    public static final Map<RobotState, Animation> animMap = Map.of(
            RobotState.Idle,
    ...
    public static final Animation disabledAnim = new SingleFadeAnimation(
    ...
    public static Command flowAnimation(LEDIO io, LED led) {
        ColorFlowAnimation blue = new ColorFlowAnimation(0, 0, 255, 0, 0.8, LEDConstants.length, Direction.Forward);
        ColorFlowAnimation yellow = new ColorFlowAnimation(255, 255, 0, 0, 0.8, LEDConstants.length,
                Direction.Backward);
        return Commands.run(
                () -> Commands.sequence(
